...
namespace PostgreSQLDb.Migrations
{
    ...
    [Migration("20240415194449_AddNewEntityTag")]
    partial class AddNewEntityTag
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EducationPageWebAPI.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ArticleId = "2e0d14ed-052a-4b4d-bf5b-014647277a3d",
            ...
            modelBuilder.Entity("Models.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TagId = "086aa62e-2d48-415d-bf82-1d674a95d194",
                            Value = "акции"
                        });
                });
